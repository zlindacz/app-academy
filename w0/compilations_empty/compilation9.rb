...
#   spree = {}
#   calendar_of_murderers.each_with_index do |name, idx|
#     if name == calendar_of_murderers[idx+1]
#       start_date = idx
#     elsif name != calendar_of_murderers[idx+1]
#       end_date = idx
#     end
#     date_range = [start_date, end_date]
#     spree[name] =  date_range if date_range.any?
#   end
...
puts number_counting_seq(4) == "1211"
