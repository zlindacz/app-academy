...
Comment.create!(body: "I'm so hungry. Got any fries?", commentable_id: 2, commentable_type: 'User')
Comment.create!(body: "Lets go to McD's!", commentable_id: 1, commentable_type: 'Contact')
Comment.create!(body: "Garlic fries!!!", commentable_id: 3, commentable_type: 'User')
